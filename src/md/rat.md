...
The result was finicky, but it did work.
Since learning JS and React, I decided to recreate my old project with a 3D model and customization features.
...
## Links
- Website: [rat.dance](https://rat.dance)
- Source code: [dan/rat](https://git.dgd.sh/dan/rat)
